...
func (b *BlockChain) FetchSpendJournal(targetBlock *soterutil.Block) ([]SpentTxOut, error) {
	b.chainLock.RLock()
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHeight(blockHeight int32) (*soterutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*soterutil.Block, error) {
