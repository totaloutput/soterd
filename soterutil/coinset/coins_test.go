...
func NewCoin(index int64, value soterutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	// should be two outpoints, with 1st one having 0.035SOTO value.
	...
	testSimpleCoinTxValue0            = soterutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = soterutil.NewTxFromBytes(testSimpleCoinTxBytes)
