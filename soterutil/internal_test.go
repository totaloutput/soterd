...
/*
This test file is part of the soterutil package rather than than the
soterutil_test package so it can bridge access to the internals to properly test
...
func TstAddressPubKey(serializedPubKey []byte, pubKeyFormat PubKeyFormat,
	...
	pubKey, _ := soterec.ParsePubKey(serializedPubKey, soterec.S256())
	return &AddressPubKey{
		pubKeyFormat: pubKeyFormat,
		pubKey:       (*soterec.PublicKey)(pubKey),
		pubKeyHashID: netID,
	}
}

// TstAddressSAddr returns the expected script address bytes for
// P2PKH and P2SH soter addresses.
...
// bech32 encoded P2WPKH and P2WSH soter addresses.
