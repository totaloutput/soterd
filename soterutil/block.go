...
// Block defines a soter block that provides easier and more efficient
...
// Tx returns a wrapped transaction (soterutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (soterutil.Tx) for all
...
// instead provides easy access to wrapped versions (soterutil.Tx) of them.
...
// NewBlock returns a new instance of a soter block given an underlying
...
// NewBlockFromBytes returns a new instance of a soter block given the
...
// NewBlockFromReader returns a new instance of a soter block given a
...
// NewBlockFromBlockAndBytes returns a new instance of a soter block given
