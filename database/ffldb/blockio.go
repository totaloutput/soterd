...
const (
	// The Soter protocol encodes block height as int32, so max number of
...
func newBlockStore(basePath string, network wire.SoterNet) *blockStore {
