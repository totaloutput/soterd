...
func GetBlockWeight(blk *soterutil.Block) int64 {
...
func GetTransactionWeight(tx *soterutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *soterutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
