...
// children nodes.  A diagram depicting how this works for soter transactions
...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*soterutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *soterutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *soterutil.Block) error {
